...
#define FUEL_GAUGE_ADP5360_REG_V_THERM 0x0Fu

#define FUEL_GAUGE_ADP5360_REG_V_SOC_0   0x16u
#define FUEL_GAUGE_ADP5360_REG_V_SOC_5   0x17u
#define FUEL_GAUGE_ADP5360_REG_V_SOC_11  0x18u
#define FUEL_GAUGE_ADP5360_REG_V_SOC_19  0x19u
#define FUEL_GAUGE_ADP5360_REG_V_SOC_28  0x1Au
#define FUEL_GAUGE_ADP5360_REG_V_SOC_41  0x1Bu
#define FUEL_GAUGE_ADP5360_REG_V_SOC_55  0x1Cu
#define FUEL_GAUGE_ADP5360_REG_V_SOC_69  0x1Du
#define FUEL_GAUGE_ADP5360_REG_V_SOC_84  0x1Eu
#define FUEL_GAUGE_ADP5360_REG_V_SOC_100 0x1Fu

#define FUEL_GAUGE_ADP5360_REG_BAT_CAP         0x20u
#define FUEL_GAUGE_ADP5360_REG_BAT_SOC         0x21u
#define FUEL_GAUGE_ADP5360_REG_BAT_SOC_ACM_CTL 0x22u
#define FUEL_GAUGE_ADP5360_REG_BAT_SOC_ACM_H   0x23u
#define FUEL_GAUGE_ADP5360_REG_BAT_SOC_ACM_L   0x24u
#define FUEL_GAUGE_ADP5360_REG_VBAT_READ_H     0x25u
#define FUEL_GAUGE_ADP5360_REG_VBAT_READ_L     0x26u
#define FUEL_GAUGE_ADP5360_REG_FUEL_GAUGE_MODE 0x27u
#define FUEL_GAUGE_ADP5360_REG_SOC_RESET       0x28u

#define FUEL_GAUGE_ADP5360_REG_PGOOD_STATUS 0x2Fu
...
static int fuel_gauge_adp5360_get_temp_adc(const struct device *dev, union fuel_gauge_prop_val *val)
{
	const struct fuel_gauge_adp5360_config *config = dev->config;
	const struct device *mfd_dev = config->mfd_adp5360;
	int ret;
				       ...
				       union fuel_gauge_prop_val *val)
{
	...
	case FUEL_GAUGE_TEMPERATURE:
		return fuel_gauge_adp5360_get_temp_adc(dev, val);
	default:
		return -ENOTSUP;
	}
}
